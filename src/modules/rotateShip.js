...
const Rotate = (() => {
    ...
    function shipInDock(ship) {
        return !DragDrop.hasVerticalClass(ship) && !DragDrop.hasHorizontalClass(ship);
    }
    ...
    function rotateHorizontallyInGrid(ship) {
        ...
        const adjacentSquares = DragDrop.getAdjacentSquares(targetSquare, shipWidth, "horizontal");
        const validDrop = DragDrop.isValidDrop(ship.id, shipWidth, adjacentSquares, ship, "horizontal");
        ...
        if (validDrop) {
            ...
            adjacentSquares.forEach(square => DragDrop.markSquareTaken(ship, square));
    ...
    function rotateVerticallyInGrid(ship) {
        ...
        const targetSquare = ship.parentNode.id;
        const adjacentSquares = DragDrop.getAdjacentSquares(targetSquare, shipHeight, "vertical");
        const validDrop = DragDrop.isValidDrop(ship.id, shipHeight, adjacentSquares, ship, "vertical");
